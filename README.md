...
**Note**: Work is actively being done on a more generalized Cosmos Indexer model. That work can be seen in the [Cosmos Indexer](https://github.com/DefiantLabs/cosmos-tax-cli) project.
